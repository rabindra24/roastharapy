          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <form onSubmit={formHandler} method="post" className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a href="mailto:roastharapy@email.com" className="text-black">roastharapy@email.com</a>
                <p className="leading-normal my-5">
                  
                  Near Police Station Parasia , 480441
                </p>
                <span className="inline-flex">
                  <a href="https://roastharapy.vercel.app/" className="text-gray-500" aria-label="instagram">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                  ...
                  <a href="https://www.facebook.com/profile.php?id=100079602835785" className="ml-4 text-gray-500" aria-label="instagram">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <a href="https://www.instagram.com/rabindra_nath_mahat0/" aria-label="instagram" className="ml-4 text-gray-500">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                  ...
                  <a href="#contact" className="ml-4 text-gray-500" aria-label="twitter">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
