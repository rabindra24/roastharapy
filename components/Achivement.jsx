    ...
    <div className='grid md:grid-cols-2 gird-cols-1 md:gap-16 gap-5 md:p-4 px-2 py-4 max-w-[1100px]'>
        {
            data.map((item)=>(
                <div key={item.id} className='px-4 py-8 bg-gray-100  border-gray-300 border-2'>
                    ...
                    <p className='buttonGradient text-white font-bold md:px-10 px-5 md:py-4 py-2 max-w-[250px] mx-auto rounded-full block relative text-center md:-mt-5 -mt-3 z-[100] mb-3'>{item.company}</p>
